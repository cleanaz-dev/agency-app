   ...
   <div className="pt-100 pb-70">
    <div className="container">
     <div className="section-title">
      <h2>Our Services</h2>
      <p>
       Discover our diverse range of AI-driven services designed to elevate and
       streamline your business operations. From AI consultancy and automation
       to advanced chatbot and voice assistance, we offer innovative solutions
